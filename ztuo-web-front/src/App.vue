    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          ...
          <p>Copyright © 2012-2021 WWW.BIZZAN.VIP All rights reserved.&nbsp;&nbsp;</p>
         <!-- <div class="social-list">
            <ul>
              <Tooltip content="Wechat" theme="dark" placement="top">
                ...
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/wechatqrcode.jpg">
                </div>
              </Tooltip>
              <Tooltip content="Biyong" theme="dark" placement="top">
                ...
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/biyongqrcode.png">
                </div>
              </Tooltip>
              <Tooltip content="Telegram" theme="dark" placement="top">
                ...
                <div slot="content">
                    <img style="width: 130px;border-radius: 5px;" src="./assets/images/telegramqrcode.jpg">
                </div>
              </Tooltip>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">servicebizzan@gmail.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
...
export default {
  ...
  watch: {
	...
	case "nav-cexchange":
          ...
          break;
        default:
          window.document.title = "BIZZAN | digital currency trading platform";
          break;
      }
    },
    $route(to, from) {
