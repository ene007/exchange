  ...
  <div class="invite">
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://bizzantest.oss-cn-hongkong.aliyuncs.com/2019/08/08/promotioncard.png"></img>
        <div class="desc">
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://WWW.BIZZAN.VIP/register?code=000000"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
