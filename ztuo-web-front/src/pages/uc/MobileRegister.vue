  ...
  <div class="login_form mob-login">
    <div class="login_right">
      <div style="color: #F90;margin-bottom: 60px;margin-top: 60px;">
        <h1 style="border-left: 5px solid #F90;padding-left: 10px;letter-spacing: 2px;line-height:30px;height:30px;">bizzan.vip</h1>
        ...
        <FormItem prop="user">
          <Input type="text" v-model="formInline.user" :placeholder="key">
            <Select v-model="country" slot="prepend" style="width: 65px;border-bottom: 1px solid #27313e;">
			  ...
			  <Option value="瑞士" label="+41"><span>+41</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Swiss')}}</span></Option>
              <Option value="荷兰" label="+31"><span>+31</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Netherlands')}}</span></Option>
              <Option value="比利时" label="+32"><span>+32</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Belgium')}}</span></Option>
              <Option value="澳大利亚" label="+61"><span>+61</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Australia')}}</span></Option>
              ...
              <Option value="瑞典" label="+46"><span>+46</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Sweden')}}</span></Option>
              <Option value="墨西哥" label="+52"><span>+52</span><span style="margin-left:10px;color:#ccc">{{$t('uc.regist.Mexico')}}</span></Option>             
