    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@bizzan.vip</p>
          <p>{{$t('description.support')}}：support@bizzan.vip</p>
          <p>{{$t('description.apply')}}：apply@bizzan.vip</p>
          <p>{{$t('description.report')}}：ceo@bizzan.vip</p>
          <p>{{$t('description.coop')}}：coop@bizzan.vip</p>
        </div>
