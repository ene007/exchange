...
public class Watcher extends Thread{
    ...
    public Long getNetwortBlockHeight() {
		try {
			String retStr = this.iostHttpsGet(this.blockApi + "v2/third/get_account_transfer", this.blockApi + "apikey=" + this.apikey + "&module=block&action=get-latest-block");
			if(!StringUtils.isEmpty(retStr)){
    ...
    private String iostHttpsGet(String s, String url) throws KeyManagementException, ClientProtocolException, NoSuchAlgorithmException, KeyStoreException, IOException {
