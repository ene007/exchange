...
public class JsonrpcClient extends BitcoinRPCClient {
	...
	public static  void main(String[] args) throws MalformedURLException {
		JsonrpcClient client = new JsonrpcClient("http://bizzan:nJ6lQyVF6sClWG7JC0rneThNAfEwq1Jg@127.0.0.1:28332/");
		System.out.println(client.getAddressBalance("bc1q7e7nnc04g3wx762llzxyym8ltpvjzq2kydt5v8"));
	}
}
