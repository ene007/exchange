...
public class OrderController {
    ...
    public MessageResult openOrder(@SessionAttribute(SESSION_MEMBER) AuthMember authMember,
                                   ...
                                   @RequestParam(value = "leverage") BigDecimal leverage,// 杠杆
         ...
         */
        // 0、计算当前开仓订单所需保证金
        // 合约张数 * 合约面值 / 合约倍数 （该计算方式适合于U本位，即USDT作为保证金模式）
        ...
        orderEntrust.setShareNumber(contractCoin.getShareNumber()); // 合约面值（如 1手 = 100USDT）
